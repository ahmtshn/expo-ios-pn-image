...
// project `ios/FBNotificationServiceExtension` directory
const entitlementsFileName = `FBNotificationServiceExtension.entitlements`;
const plistFileName = `FBNotificationServiceExtension-Info.plist`;
